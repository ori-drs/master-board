...
int main(int argc, char **argv)
{
    ...
    trajectoryParameters[motor_i].frequencyStart = 0.001;
	...
	trajectoryParameters[motor_i].amplitude = 4.;
	...
	motor_i = FRHFE;
	trajectoryParameters[motor_i].active = 1;
	trajectoryParameters[motor_i].amplitude = 7.0;
    trajectoryParameters[motor_i].frequencyStart = 0.4;
    trajectoryParameters[motor_i].frequencyInclination = 0.0;
	trajectoryParameters[motor_i].frequencyEnd = 0.4;
	trajectoryParameters[motor_i].phaseshift = 0;//M_PI/4;
	trajectoryParameters[motor_i].start_pos = -0*M_PI/16*GEAR_RATIO;
